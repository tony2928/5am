                ...
                <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
                    <ul class="list-reset lg:flex justify-end flex-1 items-center">
                        @if (Route::has('login'))
                            @auth
                                <li class="mr-3">
                                    <a href="{{ route("dashboard") }}" class="inline-block py-2 px-4 text-black font-bold no-underline hover:underline">Dashboard</a>
                                </li>
                            @else
                                <li class="mr-3">
                                    <a href="{{ route("login") }}" class="inline-block py-2 px-4 text-black font-bold no-underline hover:underline">Login</a>
                                </li>
                    </ul>
                                @if(Route::has('register'))
                                    <ul>
                                        <li class="mr-3">
                                            <a href="{{ route("register") }}" class="mx-auto lg:mx-0 hover:underline bg-white text-black font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75">Register</a>
                                        </li>
                                    </ul>
                                @endif
                            @endauth
        ...
        <div class="pt-24">
            <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                ...
                <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                    <p class="uppercase tracking-loose w-full">Trabajo escolar</p>
                    <h1 class="my-4 text-5xl font-bold leading-tight">Proyecto</h1>
                    <p class="leading-normal text-2xl mb-8">Miembros: Lucero, Daniel, Viridiana, Melanni, Carmen, Antonio</p>
                ...
                <div class="flex flex-wrap">
                    <div class="w-5/6 sm:w-1/2 p-6">
                        ...
                        <p class="text-gray-600 mb-8">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam at ipsum eu nunc commodo posuere et sit amet ligula.<br/>
                            <br/>
                ...
                <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                    <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                        <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                            ...
                            <p class="text-gray-800 text-base px-6 mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam at ipsum eu nunc commodo posuere et sit amet ligula.
						</p>
                        </a>
                    </div>
